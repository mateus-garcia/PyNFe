...
#
# Generated Mon Nov 16 20:06:49 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_cancela_NFe_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoCancelamentoNFe_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_cancela_NFe_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoCancelamentoNFe_v01.xsd
#
...
class PedidoCancelamentoNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoCancelamentoNFe',
               pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoCancelamentoNFe',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        for Detalhe_ in self.Detalhe:
            ...
            Detalhe_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Detalhe',
                            pretty_print=pretty_print)
...
class DetalheType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='DetalheType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DetalheType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if self.AssinaturaCancelamento is not None:
            namespaceprefix_ = self.AssinaturaCancelamento_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.AssinaturaCancelamento_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAssinaturaCancelamento>%s</%sAssinaturaCancelamento>%s' % (
                namespaceprefix_,
                self.gds_format_base64(self.AssinaturaCancelamento, input_name='AssinaturaCancelamento'),
                namespaceprefix_, eol_))
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_cancela_NFe_v01 import *\n\n')
        sys.stdout.write('import servico_cancela_NFe_v01 as model_\n\n')
