...
#
# Generated Mon Nov 16 20:12:30 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_informacoes_lote_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoInformacoesLote_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_informacoes_lote_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoInformacoesLote_v01.xsd
#
...
class PedidoInformacoesLote(GeneratedsSuper):
    """Schema utilizado para PEDIDO de informações de lote.Este Schema XML é
    utilizado pelos prestadores de serviços para obterem informações de
    lotes de RPS que geraram NFS-e."""
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoInformacoesLote',
               pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoInformacoesLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoInformacoesLote',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoInformacoesLote'):
        pass
...
class CabecalhoType(GeneratedsSuper):
    ...
    def __init__(self, Versao='1', CPFCNPJRemetente=None, NumeroLote=None, InscricaoPrestador=None, gds_collector_=None,
                 **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_informacoes_lote_v01 import *\n\n')
        sys.stdout.write('import servico_informacoes_lote_v01 as model_\n\n')
