...
#
# Generated Mon Nov 16 20:09:38 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_consulta_NFe_periodo_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoConsultaNFePeriodo_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_consulta_NFe_periodo_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoConsultaNFePeriodo_v01.xsd
#
...
class PedidoConsultaNFePeriodo(GeneratedsSuper):
    ...
    por período.Este Schema XML é utilizado pelos Prestadores/Tomadores de
    serviços consultarem NFS-e Emitidas ou Recebidas por eles."""
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='PedidoConsultaNFePeriodo',
               pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoConsultaNFePeriodo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaNFePeriodo',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if self.Cabecalho is not None:
            ...
            self.Cabecalho.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Cabecalho',
                                  pretty_print=pretty_print)
        if self.Signature is not None:
            namespaceprefix_ = self.Signature_nsprefix_ + ':' if (UseCapturedNS_ and self.Signature_nsprefix_) else ''
            self.Signature.export(outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='Signature',
                                  pretty_print=pretty_print)
...
class tpEvento(GeneratedsSuper):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCodigoEvento_patterns_,))
                result = False
        return result
    ...
    def validate_tpDescricaoEvento(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 300:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpDescricaoEvento' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpDescricaoEvento' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpEvento',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpEvento',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
                       namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpEvento',
        ...
        if self.Codigo is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCodigo>%s</%sCodigo>%s' % (
                namespaceprefix_, self.gds_format_integer(self.Codigo, input_name='Codigo'), namespaceprefix_, eol_))
        if self.Descricao is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDescricao>%s</%sDescricao>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.Descricao), input_name='Descricao')), namespaceprefix_, eol_))
        if self.ChaveRPS is not None:
            namespaceprefix_ = self.ChaveRPS_nsprefix_ + ':' if (UseCapturedNS_ and self.ChaveRPS_nsprefix_) else ''
            self.ChaveRPS.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ChaveRPS',
                                 pretty_print=pretty_print)
        if self.ChaveNFe is not None:
            namespaceprefix_ = self.ChaveNFe_nsprefix_ + ':' if (UseCapturedNS_ and self.ChaveNFe_nsprefix_) else ''
            self.ChaveNFe.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ChaveNFe',
                                 pretty_print=pretty_print)
...
class tpCPFCNPJ(GeneratedsSuper):
    ...
    def validate_tpCPF(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCPF_patterns_,))
                result = False
        return result
    ...
    def validate_tpCNPJ(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCNPJ_patterns_,))
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpCPFCNPJ',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpCPFCNPJ',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.CPF is not None:
            ...
            outfile.write('<%sCPF>%s</%sCPF>%s' % (
                namespaceprefix_, self.gds_encode(self.gds_format_string(quote_xml(self.CPF), input_name='CPF')),
        ...
        if self.CNPJ is not None:
            ...
            outfile.write('<%sCNPJ>%s</%sCNPJ>%s' % (
                namespaceprefix_, self.gds_encode(self.gds_format_string(quote_xml(self.CNPJ), input_name='CNPJ')),
                namespaceprefix_, eol_))
...
class tpChaveNFeRPS(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpChaveNFeRPS',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpChaveNFeRPS',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
...
class tpChaveNFe(GeneratedsSuper):
    ...
    def validate_tpInscricaoMunicipal(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpInscricaoMunicipal_patterns_,))
                result = False
        return result
    ...
    def validate_tpNumero(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpNumero_patterns_,))
                result = False
        return result
    ...
    def validate_tpCodigoVerificacao(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 8:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpCodigoVerificacao' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 8:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpCodigoVerificacao' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpChaveNFe',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpChaveNFe',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.InscricaoPrestador is not None:
            namespaceprefix_ = self.InscricaoPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.InscricaoPrestador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoPrestador>%s</%sInscricaoPrestador>%s' % (
                namespaceprefix_, self.gds_format_integer(self.InscricaoPrestador, input_name='InscricaoPrestador'),
                namespaceprefix_, eol_))
        if self.NumeroNFe is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroNFe>%s</%sNumeroNFe>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroNFe, input_name='NumeroNFe'), namespaceprefix_,
                eol_))
        if self.CodigoVerificacao is not None:
            namespaceprefix_ = self.CodigoVerificacao_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CodigoVerificacao_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCodigoVerificacao>%s</%sCodigoVerificacao>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoVerificacao), input_name='CodigoVerificacao')),
                                                                               namespaceprefix_, eol_))
...
class tpChaveRPS(GeneratedsSuper):
    ...
    def validate_tpSerieRPS(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpSerieRPS' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpSerieRPS' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpChaveRPS',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpChaveRPS',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.SerieRPS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSerieRPS>%s</%sSerieRPS>%s' % (
                namespaceprefix_,
                self.gds_encode(self.gds_format_string(quote_xml(self.SerieRPS), input_name='SerieRPS')),
                namespaceprefix_, eol_))
        if self.NumeroRPS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroRPS>%s</%sNumeroRPS>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroRPS, input_name='NumeroRPS'), namespaceprefix_,
                eol_))
...
class tpEndereco(GeneratedsSuper):
    ...
    def __init__(self, TipoLogradouro=None, Logradouro=None, NumeroEndereco=None, ComplementoEndereco=None, Bairro=None,
                 Cidade=None, UF=None, CEP=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def validate_tpTipoLogradouro(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 3:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpTipoLogradouro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpTipoLogradouro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpLogradouro(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 50:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpLogradouro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpLogradouro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpNumeroEndereco(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpNumeroEndereco' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpNumeroEndereco' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpComplementoEndereco(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 30:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpComplementoEndereco' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpComplementoEndereco' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpBairro(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 30:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpBairro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpBairro' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpCidade(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCidade_patterns_,))
                result = False
        return result
    ...
    def validate_tpUF(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpUF' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpUF' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpCEP(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCEP_patterns_,))
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpEndereco',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpEndereco',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.TipoLogradouro is not None:
            namespaceprefix_ = self.TipoLogradouro_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.TipoLogradouro_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTipoLogradouro>%s</%sTipoLogradouro>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.TipoLogradouro), input_name='TipoLogradouro')), namespaceprefix_,
                                                                         eol_))
        if self.Logradouro is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLogradouro>%s</%sLogradouro>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.Logradouro), input_name='Logradouro')), namespaceprefix_, eol_))
        if self.NumeroEndereco is not None:
            namespaceprefix_ = self.NumeroEndereco_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.NumeroEndereco_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroEndereco>%s</%sNumeroEndereco>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.NumeroEndereco), input_name='NumeroEndereco')), namespaceprefix_,
                                                                         eol_))
        if self.ComplementoEndereco is not None:
            namespaceprefix_ = self.ComplementoEndereco_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ComplementoEndereco_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sComplementoEndereco>%s</%sComplementoEndereco>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.ComplementoEndereco), input_name='ComplementoEndereco')),
                                                                                   namespaceprefix_, eol_))
        if self.Bairro is not None:
            namespaceprefix_ = self.Bairro_nsprefix_ + ':' if (UseCapturedNS_ and self.Bairro_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sBairro>%s</%sBairro>%s' % (
                namespaceprefix_, self.gds_encode(self.gds_format_string(quote_xml(self.Bairro), input_name='Bairro')),
                namespaceprefix_, eol_))
        if self.Cidade is not None:
            namespaceprefix_ = self.Cidade_nsprefix_ + ':' if (UseCapturedNS_ and self.Cidade_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCidade>%s</%sCidade>%s' % (
                namespaceprefix_, self.gds_format_integer(self.Cidade, input_name='Cidade'), namespaceprefix_, eol_))
        if self.UF is not None:
            namespaceprefix_ = self.UF_nsprefix_ + ':' if (UseCapturedNS_ and self.UF_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sUF>%s</%sUF>%s' % (
                namespaceprefix_, self.gds_encode(self.gds_format_string(quote_xml(self.UF), input_name='UF')),
                namespaceprefix_, eol_))
        if self.CEP is not None:
            namespaceprefix_ = self.CEP_nsprefix_ + ':' if (UseCapturedNS_ and self.CEP_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCEP>%s</%sCEP>%s' % (
                namespaceprefix_, self.gds_format_integer(self.CEP, input_name='CEP'), namespaceprefix_, eol_))
...
class tpInformacoesLote(GeneratedsSuper):
    ...
    def __init__(self, NumeroLote=None, InscricaoPrestador=None, CPFCNPJRemetente=None, DataEnvioLote=None,
                 QtdNotasProcessadas=None, TempoProcessamento=None, ValorTotalServicos=None, ValorTotalDeducoes=None,
    ...
    def validate_tpQuantidade(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpQuantidade_patterns_,))
                result = False
        return result
    ...
    def validate_tpTempoProcessamento(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpTempoProcessamento_patterns_,))
                result = False
        return result
    ...
    def validate_tpValor(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on tpValor' % {
                        "value": value, "lineno": lineno})
                result = False
            if len(str(value)) >= 15:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd totalDigits restriction on tpValor' % {
                        "value": value, "lineno": lineno})
                result = False
            if not self.gds_validate_simple_patterns(
                    self.validate_tpValor_patterns_, value):
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpValor_patterns_,))
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpInformacoesLote',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpInformacoesLote',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
                       ...
                       name_='tpInformacoesLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NumeroLote is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroLote>%s</%sNumeroLote>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroLote, input_name='NumeroLote'), namespaceprefix_,
                eol_))
        if self.InscricaoPrestador is not None:
            namespaceprefix_ = self.InscricaoPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.InscricaoPrestador_nsprefix_) else ''
        ...
        if self.CPFCNPJRemetente is not None:
            namespaceprefix_ = self.CPFCNPJRemetente_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CPFCNPJRemetente_nsprefix_) else ''
            self.CPFCNPJRemetente.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CPFCNPJRemetente',
                                         pretty_print=pretty_print)
        if self.DataEnvioLote is not None:
            namespaceprefix_ = self.DataEnvioLote_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataEnvioLote_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataEnvioLote>%s</%sDataEnvioLote>%s' % (
                namespaceprefix_, self.gds_format_datetime(self.DataEnvioLote, input_name='DataEnvioLote'),
                namespaceprefix_, eol_))
        if self.QtdNotasProcessadas is not None:
            namespaceprefix_ = self.QtdNotasProcessadas_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.QtdNotasProcessadas_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sQtdNotasProcessadas>%s</%sQtdNotasProcessadas>%s' % (
                namespaceprefix_, self.gds_format_integer(self.QtdNotasProcessadas, input_name='QtdNotasProcessadas'),
                namespaceprefix_, eol_))
        if self.TempoProcessamento is not None:
            namespaceprefix_ = self.TempoProcessamento_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.TempoProcessamento_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTempoProcessamento>%s</%sTempoProcessamento>%s' % (
                namespaceprefix_, self.gds_format_integer(self.TempoProcessamento, input_name='TempoProcessamento'),
                namespaceprefix_, eol_))
        if self.ValorTotalServicos is not None:
            namespaceprefix_ = self.ValorTotalServicos_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorTotalServicos_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorTotalServicos>%s</%sValorTotalServicos>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorTotalServicos, input_name='ValorTotalServicos'),
                namespaceprefix_, eol_))
        if self.ValorTotalDeducoes is not None:
            namespaceprefix_ = self.ValorTotalDeducoes_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorTotalDeducoes_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorTotalDeducoes>%s</%sValorTotalDeducoes>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorTotalDeducoes, input_name='ValorTotalDeducoes'),
                namespaceprefix_, eol_))
...
class tpNFe(GeneratedsSuper):
    ...
    def __init__(self, Assinatura=None, ChaveNFe=None, DataEmissaoNFe=None, NumeroLote=None, ChaveRPS=None,
                 TipoRPS=None, DataEmissaoRPS=None, CPFCNPJPrestador=None, RazaoSocialPrestador=None,
                 EnderecoPrestador=None, EmailPrestador=None, StatusNFe=None, DataCancelamento=None, TributacaoNFe=None,
                 OpcaoSimples=None, NumeroGuia=None, DataQuitacaoGuia=None, ValorServicos=None, ValorDeducoes=None,
                 ValorPIS=None, ValorCOFINS=None, ValorINSS=None, ValorIR=None, ValorCSLL=None, CodigoServico=None,
                 AliquotaServicos=None, ValorISS=None, ValorCredito=None, ISSRetido=None, CPFCNPJTomador=None,
                 InscricaoMunicipalTomador=None, InscricaoEstadualTomador=None, RazaoSocialTomador=None,
                 EnderecoTomador=None, EmailTomador=None, CPFCNPJIntermediario=None,
                 InscricaoMunicipalIntermediario=None, ISSRetidoIntermediario=None, EmailIntermediario=None,
                 Discriminacao=None, ValorCargaTributaria=None, PercentualCargaTributaria=None,
                 FonteCargaTributaria=None, CodigoCEI=None, MatriculaObra=None, MunicipioPrestacao=None,
                 NumeroEncapsulamento=None, ValorTotalRecebido=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def validate_tpTipoRPS(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on tpTipoRPS' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpRazaoSocial(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 75:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpRazaoSocial' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpRazaoSocial' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpEmail(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 75:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpEmail' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpEmail' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpStatusNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on tpStatusNFe' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpTributacaoNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpTributacaoNFe' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpTributacaoNFe' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpOpcaoSimples(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on tpOpcaoSimples' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpCodigoServico(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpCodigoServico_patterns_,))
                result = False
        return result
    ...
    def validate_tpAliquota(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on tpAliquota' % {
                        "value": value, "lineno": lineno})
                result = False
            if len(str(value)) >= 5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd totalDigits restriction on tpAliquota' % {
                        "value": value, "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpInscricaoEstadual(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpInscricaoEstadual_patterns_,))
                result = False
        return result
    ...
    def validate_tpDiscriminacao(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 2000:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpDiscriminacao' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpDiscriminacao' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpPercentualCargaTributaria(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on tpPercentualCargaTributaria' % {
                        "value": value, "lineno": lineno})
                result = False
            if len(str(value)) >= 7:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd totalDigits restriction on tpPercentualCargaTributaria' % {
                        "value": value, "lineno": lineno})
                result = False
        return result
    ...
    def validate_tpFonteCargaTributaria(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on tpFonteCargaTributaria' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message(
                    'Value "%(value)s"%(lineno)s does not match xsd minLength restriction on tpFonteCargaTributaria' % {
                        "value": encode_str_2_3(value), "lineno": lineno})
                result = False
        return result
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpNFe',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpNFe',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.Assinatura is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAssinatura>%s</%sAssinatura>%s' % (
                namespaceprefix_, self.gds_format_base64(self.Assinatura, input_name='Assinatura'), namespaceprefix_,
                eol_))
        if self.ChaveNFe is not None:
            namespaceprefix_ = self.ChaveNFe_nsprefix_ + ':' if (UseCapturedNS_ and self.ChaveNFe_nsprefix_) else ''
            self.ChaveNFe.export(outfile, level, namespaceprefix_, namespacedef_='', name_='ChaveNFe',
        ...
        if self.DataEmissaoNFe is not None:
            namespaceprefix_ = self.DataEmissaoNFe_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataEmissaoNFe_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataEmissaoNFe>%s</%sDataEmissaoNFe>%s' % (
                namespaceprefix_, self.gds_format_datetime(self.DataEmissaoNFe, input_name='DataEmissaoNFe'),
                namespaceprefix_, eol_))
        if self.NumeroLote is not None:
            namespaceprefix_ = self.NumeroLote_nsprefix_ + ':' if (UseCapturedNS_ and self.NumeroLote_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.TipoRPS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTipoRPS>%s</%sTipoRPS>%s' % (
                namespaceprefix_,
                self.gds_encode(self.gds_format_string(quote_xml(self.TipoRPS), input_name='TipoRPS')),
                namespaceprefix_, eol_))
        if self.DataEmissaoRPS is not None:
            namespaceprefix_ = self.DataEmissaoRPS_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataEmissaoRPS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataEmissaoRPS>%s</%sDataEmissaoRPS>%s' % (
                namespaceprefix_, self.gds_format_date(self.DataEmissaoRPS, input_name='DataEmissaoRPS'),
                namespaceprefix_,
                eol_))
        if self.CPFCNPJPrestador is not None:
            namespaceprefix_ = self.CPFCNPJPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CPFCNPJPrestador_nsprefix_) else ''
            self.CPFCNPJPrestador.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CPFCNPJPrestador',
                                         pretty_print=pretty_print)
        if self.RazaoSocialPrestador is not None:
            namespaceprefix_ = self.RazaoSocialPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.RazaoSocialPrestador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRazaoSocialPrestador>%s</%sRazaoSocialPrestador>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.RazaoSocialPrestador), input_name='RazaoSocialPrestador')),
                                                                                     namespaceprefix_, eol_))
        if self.EnderecoPrestador is not None:
            namespaceprefix_ = self.EnderecoPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.EnderecoPrestador_nsprefix_) else ''
            self.EnderecoPrestador.export(outfile, level, namespaceprefix_, namespacedef_='', name_='EnderecoPrestador',
                                          pretty_print=pretty_print)
        if self.EmailPrestador is not None:
            namespaceprefix_ = self.EmailPrestador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.EmailPrestador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmailPrestador>%s</%sEmailPrestador>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.EmailPrestador), input_name='EmailPrestador')), namespaceprefix_,
                                                                         eol_))
        if self.StatusNFe is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sStatusNFe>%s</%sStatusNFe>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.StatusNFe), input_name='StatusNFe')), namespaceprefix_, eol_))
        if self.DataCancelamento is not None:
            namespaceprefix_ = self.DataCancelamento_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataCancelamento_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataCancelamento>%s</%sDataCancelamento>%s' % (
                namespaceprefix_, self.gds_format_datetime(self.DataCancelamento, input_name='DataCancelamento'),
                namespaceprefix_, eol_))
        if self.TributacaoNFe is not None:
            namespaceprefix_ = self.TributacaoNFe_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.TributacaoNFe_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTributacaoNFe>%s</%sTributacaoNFe>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.TributacaoNFe), input_name='TributacaoNFe')), namespaceprefix_,
                                                                       eol_))
        if self.OpcaoSimples is not None:
            namespaceprefix_ = self.OpcaoSimples_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.OpcaoSimples_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sOpcaoSimples>%s</%sOpcaoSimples>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.OpcaoSimples), input_name='OpcaoSimples')), namespaceprefix_,
                                                                     eol_))
        if self.NumeroGuia is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroGuia>%s</%sNumeroGuia>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroGuia, input_name='NumeroGuia'), namespaceprefix_,
                eol_))
        if self.DataQuitacaoGuia is not None:
            namespaceprefix_ = self.DataQuitacaoGuia_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataQuitacaoGuia_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataQuitacaoGuia>%s</%sDataQuitacaoGuia>%s' % (
                namespaceprefix_, self.gds_format_date(self.DataQuitacaoGuia, input_name='DataQuitacaoGuia'),
                namespaceprefix_, eol_))
        if self.ValorServicos is not None:
            namespaceprefix_ = self.ValorServicos_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorServicos_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorServicos>%s</%sValorServicos>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorServicos, input_name='ValorServicos'),
                namespaceprefix_,
                eol_))
        if self.ValorDeducoes is not None:
            namespaceprefix_ = self.ValorDeducoes_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorDeducoes_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorDeducoes>%s</%sValorDeducoes>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorDeducoes, input_name='ValorDeducoes'),
                namespaceprefix_,
                eol_))
        if self.ValorPIS is not None:
            namespaceprefix_ = self.ValorPIS_nsprefix_ + ':' if (UseCapturedNS_ and self.ValorPIS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorPIS>%s</%sValorPIS>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorPIS, input_name='ValorPIS'), namespaceprefix_,
                eol_))
        if self.ValorCOFINS is not None:
            namespaceprefix_ = self.ValorCOFINS_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorCOFINS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorCOFINS>%s</%sValorCOFINS>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorCOFINS, input_name='ValorCOFINS'), namespaceprefix_,
                eol_))
        if self.ValorINSS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorINSS>%s</%sValorINSS>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorINSS, input_name='ValorINSS'), namespaceprefix_,
                eol_))
        if self.ValorIR is not None:
            namespaceprefix_ = self.ValorIR_nsprefix_ + ':' if (UseCapturedNS_ and self.ValorIR_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorIR>%s</%sValorIR>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorIR, input_name='ValorIR'), namespaceprefix_, eol_))
        if self.ValorCSLL is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorCSLL>%s</%sValorCSLL>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorCSLL, input_name='ValorCSLL'), namespaceprefix_,
                eol_))
        if self.CodigoServico is not None:
            namespaceprefix_ = self.CodigoServico_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CodigoServico_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCodigoServico>%s</%sCodigoServico>%s' % (
                namespaceprefix_, self.gds_format_integer(self.CodigoServico, input_name='CodigoServico'),
                namespaceprefix_,
                eol_))
        if self.AliquotaServicos is not None:
            namespaceprefix_ = self.AliquotaServicos_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.AliquotaServicos_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAliquotaServicos>%s</%sAliquotaServicos>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.AliquotaServicos, input_name='AliquotaServicos'),
                namespaceprefix_, eol_))
        if self.ValorISS is not None:
            namespaceprefix_ = self.ValorISS_nsprefix_ + ':' if (UseCapturedNS_ and self.ValorISS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorISS>%s</%sValorISS>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorISS, input_name='ValorISS'), namespaceprefix_,
                eol_))
        if self.ValorCredito is not None:
            namespaceprefix_ = self.ValorCredito_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorCredito_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorCredito>%s</%sValorCredito>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorCredito, input_name='ValorCredito'),
                namespaceprefix_,
                eol_))
        if self.ISSRetido is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sISSRetido>%s</%sISSRetido>%s' % (
                namespaceprefix_, self.gds_format_boolean(self.ISSRetido, input_name='ISSRetido'), namespaceprefix_,
                eol_))
        if self.CPFCNPJTomador is not None:
            namespaceprefix_ = self.CPFCNPJTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CPFCNPJTomador_nsprefix_) else ''
            self.CPFCNPJTomador.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CPFCNPJTomador',
                                       pretty_print=pretty_print)
        if self.InscricaoMunicipalTomador is not None:
            namespaceprefix_ = self.InscricaoMunicipalTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.InscricaoMunicipalTomador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoMunicipalTomador>%s</%sInscricaoMunicipalTomador>%s' % (namespaceprefix_,
                                                                                               self.gds_format_integer(
                                                                                                   self.InscricaoMunicipalTomador,
                                                                                                   input_name='InscricaoMunicipalTomador'),
                                                                                               namespaceprefix_, eol_))
        if self.InscricaoEstadualTomador is not None:
            namespaceprefix_ = self.InscricaoEstadualTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.InscricaoEstadualTomador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoEstadualTomador>%s</%sInscricaoEstadualTomador>%s' % (namespaceprefix_,
                                                                                             self.gds_format_integer(
                                                                                                 self.InscricaoEstadualTomador,
                                                                                                 input_name='InscricaoEstadualTomador'),
                                                                                             namespaceprefix_, eol_))
        if self.RazaoSocialTomador is not None:
            namespaceprefix_ = self.RazaoSocialTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.RazaoSocialTomador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRazaoSocialTomador>%s</%sRazaoSocialTomador>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.RazaoSocialTomador), input_name='RazaoSocialTomador')),
                                                                                 namespaceprefix_, eol_))
        if self.EnderecoTomador is not None:
            namespaceprefix_ = self.EnderecoTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.EnderecoTomador_nsprefix_) else ''
            self.EnderecoTomador.export(outfile, level, namespaceprefix_, namespacedef_='', name_='EnderecoTomador',
                                        pretty_print=pretty_print)
        if self.EmailTomador is not None:
            namespaceprefix_ = self.EmailTomador_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.EmailTomador_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmailTomador>%s</%sEmailTomador>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.EmailTomador), input_name='EmailTomador')), namespaceprefix_,
                                                                     eol_))
        if self.CPFCNPJIntermediario is not None:
            namespaceprefix_ = self.CPFCNPJIntermediario_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CPFCNPJIntermediario_nsprefix_) else ''
            self.CPFCNPJIntermediario.export(outfile, level, namespaceprefix_, namespacedef_='',
                                             name_='CPFCNPJIntermediario', pretty_print=pretty_print)
        if self.InscricaoMunicipalIntermediario is not None:
            namespaceprefix_ = self.InscricaoMunicipalIntermediario_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.InscricaoMunicipalIntermediario_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoMunicipalIntermediario>%s</%sInscricaoMunicipalIntermediario>%s' % (
                namespaceprefix_,
                self.gds_format_integer(self.InscricaoMunicipalIntermediario,
                                        input_name='InscricaoMunicipalIntermediario'),
                namespaceprefix_, eol_))
        if self.ISSRetidoIntermediario is not None:
            namespaceprefix_ = self.ISSRetidoIntermediario_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ISSRetidoIntermediario_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sISSRetidoIntermediario>%s</%sISSRetidoIntermediario>%s' % (namespaceprefix_,
                                                                                         self.gds_encode(
                                                                                             self.gds_format_string(
                                                                                                 quote_xml(
                                                                                                     self.ISSRetidoIntermediario),
                                                                                                 input_name='ISSRetidoIntermediario')),
                                                                                         namespaceprefix_, eol_))
        if self.EmailIntermediario is not None:
            namespaceprefix_ = self.EmailIntermediario_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.EmailIntermediario_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sEmailIntermediario>%s</%sEmailIntermediario>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.EmailIntermediario), input_name='EmailIntermediario')),
                                                                                 namespaceprefix_, eol_))
        if self.Discriminacao is not None:
            namespaceprefix_ = self.Discriminacao_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.Discriminacao_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDiscriminacao>%s</%sDiscriminacao>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.Discriminacao), input_name='Discriminacao')), namespaceprefix_,
                                                                       eol_))
        if self.ValorCargaTributaria is not None:
            namespaceprefix_ = self.ValorCargaTributaria_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorCargaTributaria_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorCargaTributaria>%s</%sValorCargaTributaria>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorCargaTributaria, input_name='ValorCargaTributaria'),
                namespaceprefix_, eol_))
        if self.PercentualCargaTributaria is not None:
            namespaceprefix_ = self.PercentualCargaTributaria_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.PercentualCargaTributaria_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPercentualCargaTributaria>%s</%sPercentualCargaTributaria>%s' % (namespaceprefix_,
                                                                                               self.gds_format_decimal(
                                                                                                   self.PercentualCargaTributaria,
                                                                                                   input_name='PercentualCargaTributaria'),
                                                                                               namespaceprefix_, eol_))
        if self.FonteCargaTributaria is not None:
            namespaceprefix_ = self.FonteCargaTributaria_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.FonteCargaTributaria_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFonteCargaTributaria>%s</%sFonteCargaTributaria>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.FonteCargaTributaria), input_name='FonteCargaTributaria')),
                                                                                     namespaceprefix_, eol_))
        if self.CodigoCEI is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCodigoCEI>%s</%sCodigoCEI>%s' % (
                namespaceprefix_, self.gds_format_integer(self.CodigoCEI, input_name='CodigoCEI'), namespaceprefix_,
                eol_))
        if self.MatriculaObra is not None:
            namespaceprefix_ = self.MatriculaObra_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.MatriculaObra_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMatriculaObra>%s</%sMatriculaObra>%s' % (
                namespaceprefix_, self.gds_format_integer(self.MatriculaObra, input_name='MatriculaObra'),
                namespaceprefix_,
                eol_))
        if self.MunicipioPrestacao is not None:
            namespaceprefix_ = self.MunicipioPrestacao_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.MunicipioPrestacao_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMunicipioPrestacao>%s</%sMunicipioPrestacao>%s' % (
                namespaceprefix_, self.gds_format_integer(self.MunicipioPrestacao, input_name='MunicipioPrestacao'),
                namespaceprefix_, eol_))
        if self.NumeroEncapsulamento is not None:
            namespaceprefix_ = self.NumeroEncapsulamento_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.NumeroEncapsulamento_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroEncapsulamento>%s</%sNumeroEncapsulamento>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroEncapsulamento, input_name='NumeroEncapsulamento'),
                namespaceprefix_, eol_))
        if self.ValorTotalRecebido is not None:
            namespaceprefix_ = self.ValorTotalRecebido_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorTotalRecebido_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sValorTotalRecebido>%s</%sValorTotalRecebido>%s' % (
                namespaceprefix_, self.gds_format_decimal(self.ValorTotalRecebido, input_name='ValorTotalRecebido'),
                namespaceprefix_, eol_))
...
class tpRPS(GeneratedsSuper):
    ...
    def __init__(self, Assinatura=None, ChaveRPS=None, TipoRPS=None, DataEmissao=None, StatusRPS=None,
                 TributacaoRPS=None, ValorServicos=None, ValorDeducoes=None, ValorPIS=None, ValorCOFINS=None,
                 ValorINSS=None, ValorIR=None, ValorCSLL=None, CodigoServico=None, AliquotaServicos=None,
                 ISSRetido=None, CPFCNPJTomador=None, InscricaoMunicipalTomador=None, InscricaoEstadualTomador=None,
                 RazaoSocialTomador=None, EnderecoTomador=None, EmailTomador=None, CPFCNPJIntermediario=None,
                 InscricaoMunicipalIntermediario=None, ISSRetidoIntermediario=None, EmailIntermediario=None,
                 Discriminacao=None, ValorCargaTributaria=None, PercentualCargaTributaria=None,
                 FonteCargaTributaria=None, CodigoCEI=None, MatriculaObra=None, MunicipioPrestacao=None,
                 NumeroEncapsulamento=None, ValorTotalRecebido=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='tipos:',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='tpRPS',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tpRPS',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='tipos:',
        ...
        if self.DataEmissao is not None:
            namespaceprefix_ = self.DataEmissao_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DataEmissao_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDataEmissao>%s</%sDataEmissao>%s' % (
                namespaceprefix_, self.gds_format_date(self.DataEmissao, input_name='DataEmissao'), namespaceprefix_,
                eol_))
        if self.StatusRPS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sStatusRPS>%s</%sStatusRPS>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.StatusRPS), input_name='StatusRPS')), namespaceprefix_, eol_))
        if self.TributacaoRPS is not None:
            namespaceprefix_ = self.TributacaoRPS_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.TributacaoRPS_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTributacaoRPS>%s</%sTributacaoRPS>%s' % (namespaceprefix_, self.gds_encode(
                self.gds_format_string(quote_xml(self.TributacaoRPS), input_name='TributacaoRPS')), namespaceprefix_,
                                                                       eol_))
        if self.ValorServicos is not None:
            namespaceprefix_ = self.ValorServicos_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorServicos_nsprefix_) else ''
...
class SignatureType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='SignatureType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SignatureType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:',
                       namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='SignatureType',
                       fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        ...
        if self.SignedInfo is not None:
            ...
            self.SignedInfo.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SignedInfo',
                                   pretty_print=pretty_print)
        if self.SignatureValue is not None:
            namespaceprefix_ = self.SignatureValue_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.SignatureValue_nsprefix_) else ''
            self.SignatureValue.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SignatureValue',
                                       pretty_print=pretty_print)
        if self.KeyInfo is not None:
            namespaceprefix_ = self.KeyInfo_nsprefix_ + ':' if (UseCapturedNS_ and self.KeyInfo_nsprefix_) else ''
            self.KeyInfo.export(outfile, level, namespaceprefix_, namespacedef_='', name_='KeyInfo',
                                pretty_print=pretty_print)
...
class SignatureValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='SignatureValueType',
               pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SignatureValueType',
                                pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_,))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='SignatureValueType',
                       fromsubclass_=False, pretty_print=True):
        pass
...
class SignedInfoType(GeneratedsSuper):
    ...
    def __init__(self, Id=None, CanonicalizationMethod=None, SignatureMethod=None, Reference=None, gds_collector_=None,
                 **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='ds:',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='SignedInfoType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SignedInfoType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:',
        ...
        if self.CanonicalizationMethod is not None:
            namespaceprefix_ = self.CanonicalizationMethod_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CanonicalizationMethod_nsprefix_) else ''
            self.CanonicalizationMethod.export(outfile, level, namespaceprefix_, namespacedef_='',
                                               name_='CanonicalizationMethod', pretty_print=pretty_print)
        if self.SignatureMethod is not None:
            namespaceprefix_ = self.SignatureMethod_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.SignatureMethod_nsprefix_) else ''
            self.SignatureMethod.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SignatureMethod',
                                        pretty_print=pretty_print)
        for Reference_ in self.Reference:
            namespaceprefix_ = self.Reference_nsprefix_ + ':' if (UseCapturedNS_ and self.Reference_nsprefix_) else ''
            Reference_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Reference',
                              pretty_print=pretty_print)
...
class ReferenceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='ReferenceType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ReferenceType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='ds:', name_='ReferenceType'):
        ...
        if self.URI is not None and 'URI' not in already_processed:
            ...
            outfile.write(
                ' URI=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.URI), input_name='URI')),))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:',
        ...
        if self.Transforms is not None:
            ...
            self.Transforms.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Transforms',
                                   pretty_print=pretty_print)
        if self.DigestMethod is not None:
            namespaceprefix_ = self.DigestMethod_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DigestMethod_nsprefix_) else ''
            self.DigestMethod.export(outfile, level, namespaceprefix_, namespacedef_='', name_='DigestMethod',
                                     pretty_print=pretty_print)
        if self.DigestValue is not None:
            namespaceprefix_ = self.DigestValue_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.DigestValue_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDigestValue>%s</%sDigestValue>%s' % (
                namespaceprefix_, self.gds_format_base64(self.DigestValue, input_name='DigestValue'), namespaceprefix_,
                eol_))
...
class TransformsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='TransformsType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TransformsType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:',
        ...
        for Transform_ in self.Transform:
            ...
            Transform_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Transform',
                              pretty_print=pretty_print)
...
class TransformType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='TransformType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TransformType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='TransformType',
                       fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
        ...
        for XPath_ in self.XPath:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sXPath>%s</%sXPath>%s' % (
                namespaceprefix_, self.gds_encode(self.gds_format_string(quote_xml(XPath_), input_name='XPath')),
                namespaceprefix_, eol_))
...
class KeyInfoType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='KeyInfoType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='KeyInfoType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:',
                       namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='KeyInfoType',
                       fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
        ...
        if self.X509Data is not None:
            ...
            self.X509Data.export(outfile, level, namespaceprefix_, namespacedef_='', name_='X509Data',
                                 pretty_print=pretty_print)
...
class KeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='KeyValueType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='KeyValueType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='KeyValueType',
                       fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
        ...
        if self.RSAKeyValue is not None:
            namespaceprefix_ = self.RSAKeyValue_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.RSAKeyValue_nsprefix_) else ''
            self.RSAKeyValue.export(outfile, level, namespaceprefix_, namespacedef_='', name_='RSAKeyValue',
                                    pretty_print=pretty_print)
...
class X509DataType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='X509DataType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='X509DataType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='ds:', namespacedef_='', name_='X509DataType',
                       fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
        ...
        if self.X509Certificate is not None:
            namespaceprefix_ = self.X509Certificate_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.X509Certificate_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sX509Certificate>%s</%sX509Certificate>%s' % (
                namespaceprefix_, self.gds_format_base64(self.X509Certificate, input_name='X509Certificate'),
                namespaceprefix_, eol_))
...
class CabecalhoType(GeneratedsSuper):
    ...
    def __init__(self, Versao='1', CPFCNPJRemetente=None, CPFCNPJ=None, Inscricao=None, dtInicio=None, dtFim=None,
                 NumeroPagina=1, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def get_NumeroPagina(self):
        return self.NumeroPagina

    def set_NumeroPagina(self, NumeroPagina):
        self.NumeroPagina = NumeroPagina
    ...
    def validate_tpVersao(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (
                    encode_str_2_3(value), self.validate_tpVersao_patterns_,))
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos" ', name_='CabecalhoType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CabecalhoType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if self.CPFCNPJ is not None:
            ...
            self.CPFCNPJ.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CPFCNPJ',
                                pretty_print=pretty_print)
        if self.Inscricao is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricao>%s</%sInscricao>%s' % (
                namespaceprefix_, self.gds_format_integer(self.Inscricao, input_name='Inscricao'), namespaceprefix_,
                eol_))
        if self.dtInicio is not None:
            namespaceprefix_ = self.dtInicio_nsprefix_ + ':' if (UseCapturedNS_ and self.dtInicio_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtInicio>%s</%sdtInicio>%s' % (
                namespaceprefix_, self.gds_format_date(self.dtInicio, input_name='dtInicio'), namespaceprefix_, eol_))
        if self.dtFim is not None:
            namespaceprefix_ = self.dtFim_nsprefix_ + ':' if (UseCapturedNS_ and self.dtFim_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtFim>%s</%sdtFim>%s' % (
                namespaceprefix_, self.gds_format_date(self.dtFim, input_name='dtFim'), namespaceprefix_, eol_))
        if self.NumeroPagina is not None:
            namespaceprefix_ = self.NumeroPagina_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.NumeroPagina_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroPagina>%s</%sNumeroPagina>%s' % (
                namespaceprefix_, self.gds_format_integer(self.NumeroPagina, input_name='NumeroPagina'),
                namespaceprefix_,
                eol_))
...
class CanonicalizationMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CanonicalizationMethodType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CanonicalizationMethodType',
                                pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_,))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CanonicalizationMethodType',
                       fromsubclass_=False, pretty_print=True):
        pass
...
class SignatureMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SignatureMethodType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SignatureMethodType',
                                pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_,))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='SignatureMethodType',
                       fromsubclass_=False, pretty_print=True):
        pass
...
class DigestMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DigestMethodType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DigestMethodType',
                                pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_,))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DigestMethodType',
                       fromsubclass_=False, pretty_print=True):
        pass
...
class RSAKeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', name_='RSAKeyValueType',
               pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RSAKeyValueType',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if self.Modulus is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sModulus>%s</%sModulus>%s' % (
                namespaceprefix_, self.gds_format_base64(self.Modulus, input_name='Modulus'), namespaceprefix_, eol_))
        if self.Exponent is not None:
            namespaceprefix_ = self.Exponent_nsprefix_ + ':' if (UseCapturedNS_ and self.Exponent_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sExponent>%s</%sExponent>%s' % (
                namespaceprefix_, self.gds_format_base64(self.Exponent, input_name='Exponent'), namespaceprefix_, eol_))
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consulta_NFe_periodo_v01 import *\n\n')
        sys.stdout.write('import servico_consulta_NFe_periodo_v01 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.prefeitura.sp.gov.br/nfe': [],
                           ...
                           'http://www.w3.org/2000/09/xmldsig#': [('CryptoBinary',
                                                                   'C:\\Users\\BDR3\\PycharmProjects\\fork\\PyNFe\\pynfe\\utils\\nfse\\sp/xmldsig-core-schema_v01.xsd',
                                                                   'ST'),
                                                                  ('DigestValueType',
                                                                   'C:\\Users\\BDR3\\PycharmProjects\\fork\\PyNFe\\pynfe\\utils\\nfse\\sp/xmldsig-core-schema_v01.xsd',
                                                                   'ST'),
