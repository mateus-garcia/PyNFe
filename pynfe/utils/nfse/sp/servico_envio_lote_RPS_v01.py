...
#
# Generated Mon Nov 16 20:10:27 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_envio_lote_RPS_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoEnvioLoteRPS_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_envio_lote_RPS_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoEnvioLoteRPS_v01.xsd
#
...
class PedidoEnvioLoteRPS(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='',
               namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ',
               name_='PedidoEnvioLoteRPS', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoEnvioLoteRPS',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
                       namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ',
                       name_='PedidoEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    def __init__(self, Versao='1', CPFCNPJRemetente=None, transacao=True, dtInicio=None, dtFim=None, QtdRPS=None,
                 ValorTotalServicos=None, ValorTotalDeducoes=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='',
        ...
        if not self.transacao:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stransacao>%s</%stransacao>%s' % (
                namespaceprefix_, self.gds_format_boolean(self.transacao, input_name='transacao'), namespaceprefix_,
                eol_))
        ...
        if self.QtdRPS is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sQtdRPS>%s</%sQtdRPS>%s' % (
                namespaceprefix_, self.gds_format_integer(self.QtdRPS, input_name='QtdRPS'), namespaceprefix_, eol_))
        if self.ValorTotalServicos is not None:
            namespaceprefix_ = self.ValorTotalServicos_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.ValorTotalServicos_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_envio_lote_RPS_v01 import *\n\n')
        sys.stdout.write('import servico_envio_lote_RPS_v01 as model_\n\n')
