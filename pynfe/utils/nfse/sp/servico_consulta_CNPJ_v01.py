...
#
# Generated Mon Nov 16 20:07:31 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_consulta_CNPJ_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoConsultaCNPJ_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_consulta_CNPJ_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoConsultaCNPJ_v01.xsd
#
...
class PedidoConsultaCNPJ(GeneratedsSuper):
    ...
    utilizado pelos tomadores e/ou prestadores de serviços consultarem
    quais Inscrições Municipais (CCM) estão vinculadas a um determinado
    CNPJ e se estes CCM emitem NFS-e ou não."""
    ...
    def get_CNPJContribuinte(self):
        return self.CNPJContribuinte

    def set_CNPJContribuinte(self, CNPJContribuinte):
        self.CNPJContribuinte = CNPJContribuinte
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='PedidoConsultaCNPJ', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoConsultaCNPJ')
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaCNPJ',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoConsultaCNPJ'):
        pass

    def exportChildren(self, outfile, level, namespaceprefix_='',
                       namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ',
                       name_='PedidoConsultaCNPJ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CNPJContribuinte is not None:
            namespaceprefix_ = self.CNPJContribuinte_nsprefix_ + ':' if (
                    UseCapturedNS_ and self.CNPJContribuinte_nsprefix_) else ''
            self.CNPJContribuinte.export(outfile, level, namespaceprefix_, namespacedef_='', name_='CNPJContribuinte',
                                         pretty_print=pretty_print)
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consulta_CNPJ_v01 import *\n\n')
        sys.stdout.write('import servico_consulta_CNPJ_v01 as model_\n\n')
