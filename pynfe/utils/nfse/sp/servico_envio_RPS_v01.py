...
#
# Generated Mon Nov 16 20:11:48 2020 by generateDS.py version 2.37.1.
# Python 3.6.10 |Anaconda, Inc.| (default, Mar 23 2020, 17:58:33) [MSC v.1916 64 bit (AMD64)]
#
# Command line options:
#   ('-o', 'servico_envio_RPS_v01.py')
#
# Command line arguments:
#   C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoEnvioRPS_v01.xsd
#
# Command line:
#   generateDS.py -o "servico_envio_RPS_v01.py" C:\Users\BDR3\PycharmProjects\fork\PyNFe\pynfe\utils\nfse\sp\PedidoEnvioRPS_v01.xsd
#
...
class PedidoEnvioRPS(GeneratedsSuper):
    """Schema utilizado para PEDIDO de envio de RPS.Este Schema XML é utilizado
    pelos prestadores de serviços para substituição online e individual de
    RPS por NFS-e."""
    ...
    def export(self, outfile, level, namespaceprefix_='',
               ...
               name_='PedidoEnvioRPS', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoEnvioRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_,))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoEnvioRPS',
                                pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoEnvioRPS'):
        pass

    def exportChildren(self, outfile, level, namespaceprefix_='',
                       namespacedef_=' xmlns:tipos="http://www.prefeitura.sp.gov.br/nfe/tipos"  xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ',
                       name_='PedidoEnvioRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_envio_RPS_v01 import *\n\n')
        sys.stdout.write('import servico_envio_RPS_v01 as model_\n\n')
